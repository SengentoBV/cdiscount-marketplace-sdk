...
class CdiscountArrayOfOfferPool extends AbstractStructArrayBase
{
     ...
     */
    public function __construct(array $offerPool = array())
    {
        $this
     ...
     */
    public static function validateOfferPoolForArrayConstraintsFromSetOfferPool(array $values = array())
    {
        $message = '';
        $invalidValues = [];
     ...
     */
    public function setOfferPool(array $offerPool = array())
    {
    ...
    /**
     * Add item to OfferPool value
     * @throws \InvalidArgumentException
     * @param \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountOfferPool $item
     * @return \SengentoBV\CdiscountMarketplaceSdk\Arrays\CdiscountArrayOfOfferPool
     */
    public function addToOfferPool(\SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountOfferPool $item)
    {
        // validation for constraint: itemType

 ...
 */
class CdiscountCurrency extends AbstractStructEnumBase
{
    /**
    ...
    const VALUE_XAU = 'Xau';
    /**
     * Constant for value 'Xba'
     * @return string 'Xba'
     */
    const VALUE_XBA = 'Xba';
    /**
     * Constant for value 'Xbb'
     * @return string 'Xbb'
     */
    const VALUE_XBB = 'Xbb';
    /**
     * Constant for value 'Xbc'
     * @return string 'Xbc'
     */
    const VALUE_XBC = 'Xbc';
    /**
     * Constant for value 'Xbd'
     * @return string 'Xbd'
     */
    const VALUE_XBD = 'Xbd';
    /**
    ...
    const VALUE_XPT = 'Xpt';
    /**
     * Constant for value 'Xsu'
     * @return string 'Xsu'
     */
    const VALUE_XSU = 'Xsu';
    /**
     * Constant for value 'Xts'
     * @return string 'Xts'
     */
    const VALUE_XTS = 'Xts';
    /**
     * Constant for value 'Xua'
     * @return string 'Xua'
     */
    const VALUE_XUA = 'Xua';
    /**
     * Constant for value 'Xxx'
     * @return string 'Xxx'
     */
    const VALUE_XXX = 'Xxx';
    /**

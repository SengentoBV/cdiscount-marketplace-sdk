...
/**
 * This class stands for GetAllAllowedCategoryTree Structs
 * @package Cdiscount
 * @subpackage Structs
 */
class CdiscountGetAllAllowedCategoryTree extends AbstractStructBase
{
    /**
     * The headerMessage
    ...
    /**
     * Constructor method for GetAllAllowedCategoryTree
     * @uses CdiscountGetAllAllowedCategoryTree::setHeaderMessage()
     ...
     * @param \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountHeaderMessage $headerMessage
     * @return \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountGetAllAllowedCategoryTree
     */

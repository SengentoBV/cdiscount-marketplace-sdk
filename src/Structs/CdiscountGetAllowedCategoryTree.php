...
/**
 * This class stands for GetAllowedCategoryTree Structs
 * @package Cdiscount
 * @subpackage Structs
 */
class CdiscountGetAllowedCategoryTree extends AbstractStructBase
{
    /**
     * The headerMessage
    ...
    /**
     * Constructor method for GetAllowedCategoryTree
     * @uses CdiscountGetAllowedCategoryTree::setHeaderMessage()
     ...
     * @param \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountHeaderMessage $headerMessage
     * @return \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountGetAllowedCategoryTree
     */

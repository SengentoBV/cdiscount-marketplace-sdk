...
/**
 * This class stands for GetParcelShopList Structs
 * @package Cdiscount
 * @subpackage Structs
 */
class CdiscountGetParcelShopList extends AbstractStructBase
{
    /**
     * The headerMessage
    ...
    /**
     * Constructor method for GetParcelShopList
     * @uses CdiscountGetParcelShopList::setHeaderMessage()
     ...
     * @param \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountHeaderMessage $headerMessage
     * @return \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountGetParcelShopList
     */

...
class CdiscountOrderListMessage extends CdiscountServiceBaseAPIMessage
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \SengentoBV\CdiscountMarketplaceSdk\Arrays\CdiscountArrayOfOrder
     */
    public $OrderList;
    /**
     ...
     */
    public function setOrderList(\SengentoBV\CdiscountMarketplaceSdk\Arrays\CdiscountArrayOfOrder $orderList = null)
    {

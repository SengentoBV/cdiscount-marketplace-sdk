...
/**
 * This class stands for GetSellerInformation Structs
 * @package Cdiscount
 * @subpackage Structs
 */
class CdiscountGetSellerInformation extends AbstractStructBase
{
    /**
     * The headerMessage
    ...
    /**
     * Constructor method for GetSellerInformation
     * @uses CdiscountGetSellerInformation::setHeaderMessage()
     ...
     * @param \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountHeaderMessage $headerMessage
     * @return \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountGetSellerInformation
     */

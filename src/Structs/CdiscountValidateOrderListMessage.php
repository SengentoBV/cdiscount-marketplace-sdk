...
class CdiscountValidateOrderListMessage extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \SengentoBV\CdiscountMarketplaceSdk\Arrays\CdiscountArrayOfValidateOrder
     */
    public $OrderList;
    /**
     ...
     */
    public function setOrderList(\SengentoBV\CdiscountMarketplaceSdk\Arrays\CdiscountArrayOfValidateOrder $orderList = null)
    {

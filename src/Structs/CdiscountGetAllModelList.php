...
/**
 * This class stands for GetAllModelList Structs
 * @package Cdiscount
 * @subpackage Structs
 */
class CdiscountGetAllModelList extends AbstractStructBase
{
    /**
     * The headerMessage
    ...
    /**
     * Constructor method for GetAllModelList
     * @uses CdiscountGetAllModelList::setHeaderMessage()
     ...
     * @param \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountHeaderMessage $headerMessage
     * @return \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountGetAllModelList
     */

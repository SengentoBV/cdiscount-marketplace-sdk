...
/**
 * This class stands for GetCompetingOfferChanges Structs
 * @package Cdiscount
 * @subpackage Structs
 */
class CdiscountGetCompetingOfferChanges extends AbstractStructBase
{
    /**
     * The headerMessage
    ...
    /**
     * Constructor method for GetCompetingOfferChanges
     * @uses CdiscountGetCompetingOfferChanges::setHeaderMessage()
     ...
     * @param \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountHeaderMessage $headerMessage
     * @return \SengentoBV\CdiscountMarketplaceSdk\Structs\CdiscountGetCompetingOfferChanges
     */
